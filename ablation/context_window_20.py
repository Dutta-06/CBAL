"""
ABLATION 4c: Context Window Size — w=20
========================================
...
WINDOW_SIZE = 20   # ← only thing that differs across the three scripts
...
def main():
    ...
    print("=" * 60)
    print(f"ABLATION 4c: Context Window Size  w={WINDOW_SIZE}")
    ...
    print("\n" + "=" * 60)
    print(f"ABLATION 4c RESULTS  (w={WINDOW_SIZE})")
