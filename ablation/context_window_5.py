"""
ABLATION 4a: Context Window Size — w=5
========================================
...
WINDOW_SIZE = 5   # ← only thing that differs across the three scripts
...
def main():
    ...
    print("=" * 60)
    print(f"ABLATION 4a: Context Window Size  w={WINDOW_SIZE}")
    ...
    print("\n" + "=" * 60)
    print(f"ABLATION 4a RESULTS  (w={WINDOW_SIZE})")
